...
public class DBHelper {
	...
	public Connection openConnection() {
		String url = "jdbc:mysql://39.98.119.108:3306/c83-s2-phjx-damai?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&characterEncoding=utf8"; // 数据库的地址
		String user = "caoxiaobo"; // 数据的用户
		String password = "Caoxiaobo0917!";
		try {
			if(isAutoCommit) {
